...
User Function MT100AGR()
	...
	If INCLUI .And. SF1->F1_FORMUL == "S" .And. SF1->F1_EST == "EX" .And. IsInCallStack("U_MLCOMM01")
		...
		cQry := "SELECT D1_DOC,D1_SERIE,D1_FORNECE,D1_LOJA,D1_ITEM,D1_COD,D1_BASIMP6,D1_ALQIMP6,D1_VALIMP6,"
		...
		While !Eof()
			...
			CD5->CD5_XTEC	  := Posicione("SB1",1,xFilial("SB1") + QSD1->D1_COD,"B1_POSIPI" )
