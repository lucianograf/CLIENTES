...
User function MLFATA11()
	...
	oBrowser:SetOnlyFields( { 'D1_FILIAL', 'D1_DOC', 'D1_DTDIGIT' , 'D1_COD' , 'D1_QUANT' ,'D1_XPRTETQ' } )
	...
	*/
	...
	For iX := 1 To nQteEtq
		If !lIsHomologa
			...
			If !lImprInvent
				cPrintTxt	:= "Dt.Ent.: " + DTOC(SD1->D1_DTDIGIT)
				cPrintMsg 	+= Chr(13)+Chr(10)+cPrintTxt

				MSCBSAY(05,34,cPrintTxt,"N","2","001,001") //Imprime Texto

				cPrintTxt	:= "N.NF.: " + SD1->D1_DOC
				cPrintMsg 	+= Chr(13)+Chr(10)+cPrintTxt

				MSCBSAY(35,34,cPrintTxt,"N","2","001,001") //Imprime Texto
			Endif 

			cPrintTxt	:= "End.: " + SB1->B1_XLOCAL
			cPrintMsg 	+= Chr(13)+Chr(10)+cPrintTxt

			MSCBSAY(59,34,cPrintTxt,"N","2","001,001") //Imprime Texto
