...
/*/{Protheus.doc} MLFATC01
// Tela para pesquisar cadastro de Clientes por Cidade ou Nome
...
Static Function sfTela()
	...
	oPesquisa:bLostFocus := {|| MsgRun("Buscando clientes...","Clientes",{||sfDados(cPesquisa,cCidade)})}
	oButton 	:= TButton():New(010, 368," Pesquisar ",oPanelTop,{|| MsgRun("Buscando clientes...","Clientes",{||sfDados(cPesquisa,cCidade)})},037,013,,,.F.,.T.,.F.,,.F.,,,.F. )
...
// Efetua pesquisa na SA1 
@author Marcelo Alberto Lauschner
@since 07/08/2019
@version 1.0
@return Nil
@param cTexto, characters, descricao
@param cTexto2, characters, descricao
@type function
/*/
Static Function sfDados(cTexto,cTexto2)
