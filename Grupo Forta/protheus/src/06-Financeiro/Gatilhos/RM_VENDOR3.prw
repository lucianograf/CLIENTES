...
User Function RM_VEN3()
	...
	cQry := "SELECT (SELECT SUM((E1_VALOR) - ISNULL(E5_VALOR,0)) "
	cQry += "          FROM " + RetSqlName("SE1")+ " SE1 "
	cQry += "          LEFT JOIN " + RetSqlName("SE5") + " SE5 "
	cQry += "            ON E5_NUMERO = E1_NUM "
	cQry += "           AND E5_LOJA = E1_LOJA "
	cQry += "           AND E5_CLIFOR = E1_CLIENTE  "
	cQry += "           AND E5_TIPO = E1_TIPO "
	...
	cQry += "           AND E1_NUM = '"+ SE1->E1_NUM +"') AS VALDUP, "
	...
	cQry += "            AND E1_NUM = SE1.E1_NUM) as INDTOT, "
