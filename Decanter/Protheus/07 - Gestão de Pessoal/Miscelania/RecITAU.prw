...
//	aAdd( aTipo1, { 'CÓDIGO DO LOTE                       ', 004, 007,   'N',  4,  0, .T., 'cNum' 									} ) //LOTE IDENTIFICAÇÃO DE PAGTOS
	aAdd( aTipo1, { 'CÓDIGO DO LOTE                       ', 004, 007,   'N',  4,  0, .T., '0001' 									} ) //LOTE IDENTIFICAÇÃO DE PAGTOS
	...
	aAdd( aTipo2, { 'CÓDIGO DO LOTE                      ',  004, 007,   'N',  	4,  0, 	.T., '0001' 								 	} ) // LOTE IDENTIFICAÇÃO DE PAGTOS
//	aAdd( aTipo2, { 'CÓDIGO DO LOTE                      ',  004, 007,   'N',  	4,  0, 	.T., 'cNum' 								 	} ) // LOTE IDENTIFICAÇÃO DE PAGTOS
	...
	aAdd( aTipo2, { 'AGÊNCIA CONTA                		 ',	 024, 043,	 "C",  20,	0,	.T., "'0'+subs(SRA->RA_BCDEPSA,4,4)+SPACE(1)+STRZERO(VAL(SUBS(SRA->RA_CTDEPSA,1,10)),12)+SPACE(1)+Right(SRA->RA_CTDEPSA,1)"		 	        } )//AGÊNCIA CONTA FAVORECIDO
	...
	aAdd( aTipoHE, { 'CÓDIGO DO LOTE                     ',  004, 007,   'N',  	4,  0, 	.T., '0001' 								 } ) //LOTE IDENTIFICAÇÃO DE PAGTOS
//	aAdd( aTipoHE, { 'CÓDIGO DO LOTE                     ',  004, 007,   'N',  	4,  0, 	.T., 'cNum' 								 } ) //LOTE IDENTIFICAÇÃO DE PAGTOS
	...
	aAdd( aTipoCCE, { 'CÓDIGO DO LOTE                       ', 004, 007,   	'N',  	4,  0, 	.T., '0001' 							} ) // LOTE IDENTIFICAÇÃO DE PAGTO
//	aAdd( aTipoCCE, { 'CÓDIGO DO LOTE                       ', 004, 007,   	'N',  	4,  0, 	.T., 'cNum' 							} ) // LOTE IDENTIFICAÇÃO DE PAGTO
	...
	aAdd( aTipo3, { 'CÓDIGO DO LOTE                      ', 004, 007,  	'N',  	4,  0, 	.T., '0001' 								 } ) // LOTE IDENTIFICAÇÃO DE PAGTO
