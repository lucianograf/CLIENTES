...
User Function BOLETOACTVS(aBoletos,lReimpre)
    ...
    // TSCC34 - Diego Oliveira - 18/02/2025 - N�o Apresentar Erro
	// If Exec
    If Exec .and. !isBlind()
...
Static Function MontaRel(aMarked)
	...
	While !EOF()
        ...
        // /TSCC34 - Diego Oliveira - 18/02/2024 - Evitar erro
		If !isBlind()
		...
		if Type("_oPrtDanf")=="O"
            ...
            If cNomImpTmp == "none" //.and. isBlind()
            ...
            // TSCC34 - Diego Oliveira - 18/02/2025 - Quando Job, imprime pelo Servidor
            If !isBlind()
			    oPrintA:lServer	:=	.F.
            Else
                oPrintA:lServer	:=	.T.
		...
		If aMarked[i]
			...
			If sfValAtrib("oPrintA") <> "U"
                ...
                // TSCC34 -  18/02/2025 - Com vers�o Web, mudou a fun��o.
                If !isBlind()
