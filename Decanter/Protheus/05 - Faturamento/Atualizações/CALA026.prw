...
Static Function ModelDef()
	...
	oModel := MPFormModel():New('CALA026', /*bPreValidacao*/, {|oMdl| sfVldModl(oMdl)} /*bPosValidacao*/, /*bCommit*/, /*bCancel*/ )
...
Static Function sfVldModl(oModel)
	Local 	lRet 		:= .T. 
	Local 	nQteVol 	:= oModel:GetModel("SC5MASTER"):GetValue("C5_VOLUME1")

	If Empty(nQteVol)
		MsgAlert("Não foi informado número de volumes. Alteração não permitida.","Validação")
		lRet 	:= .F. 
	Endif 
Return lRet 
