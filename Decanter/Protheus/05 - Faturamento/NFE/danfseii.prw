...
if lNac // Layout Impressão DANFSE Nacional
	...
	cInfNota := IIF(Type("ONFSE:_DPS:_INFDPS:_SERV:_XINFCOMP") <> "U",ONFSE:_DPS:_INFDPS:_SERV:_XINFCOMP:TEXT," - ")
	...
	oDanfse:Say(074, 480, "à nota mencionada, acesse o sitio " , oFont05N:oFont) 
	oDanfse:Say(082, 480, " https://www.nfse.gov.br/consultapublica", oFont05N:oFont)
	...
	nLinea := nLinea+nLiDados 
	oDanfse:Say(nLinea, 002, SUBSTR(IIF(Type("XXXXXXXXXX") <> "U","XXXXXXXXXX"," - "),1,nMxCol11), oFont07:oFont) //BC ISSQN
	oDanfse:Say(nLinea, 200, Substr(IIF(Type("oNFSE:_DPS:_INFDPS:_VALORES:_TRIB:_TRIBMUN:_PALIQ") <> "U",oNFSE:_DPS:_INFDPS:_VALORES:_TRIB:_TRIBMUN:_PALIQ:TEXT ," - "),1,nMxCol21), oFont07:oFont) //Alíquota Aplicada
	...
	oDanfse:Say(nLinea, 480, Substr(IIF(Type("XXXXXXXXXX") <> "U","XXXXXXXXXX"," - "),1,nMxCol41), oFont07:oFont) //ISSQN Apurado
