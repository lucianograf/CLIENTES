...
User Function MA020BUT()
	...
	If __cUserId $ GetNewPar("BF_USRCTBM","000000#000130")
		Aadd(aButtRet,{"AZUL",{|| U_BFCTBM24(@M->A2_XCCPASV,M->A2_COD,M->A2_NOME) },"Cadastrar Conta Contábil" })
...
Static Function sfReceita()
	...
	If Type("oParseJSON:uf") <> "U" 
		...
		cQry += "   AND CC2_MUN LIKE '%"+ StrTran(oParseJSON:municipio,"'","''") + "%' "
