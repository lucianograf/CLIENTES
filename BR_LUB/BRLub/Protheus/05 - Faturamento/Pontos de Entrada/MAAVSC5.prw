...
Ponto de entrada na avaliação de pedido de venda 
@type function
@version  
...
User Function MAAVSC5()
	...
	Local   nInEvento   := ParamIxb[1]

	// 3 - Liberação de pedido de venda / 1 - Implantação de pedido de venda 
	If nInEvento == 3 .Or. nInEvento == 1
        // Empresa Atrialub - SC 
...
Efetua ajuste do pedido de venda estornando os itens liberados mantendo com bloqueio de estoque 
@type function
@version  
@author Marcelo Alberto Lauschner
@since 23/08/2021
