...
Static Function tomador( aDest, cCodMun )
	...
	If !lSemTomador 		
		...
		cString += '<tipopessoa>'+ iif(cCodMun $ "3552809" .and. SA1->A1_TIPO == "F" .AND. aDest[1] == "",TipoPes(AllTrim(SA1->A1_TIPO)),iif(SA1->(FieldPos("A1_TPESSOA")) > 0 .And. !Empty(SA1->A1_TPESSOA),TipoPes(AllTrim(SA1->A1_TPESSOA)),"")) +'</tipopessoa>'		
